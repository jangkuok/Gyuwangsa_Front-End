...
function PdInfoInsertComponent(props) {
    ...
    const insertProduckButtonClick = () =>{
        insertPdInfo(pdInfo).then(result =>{
            setResult({...pdInfo })
        })
    }
    ...
    return (
        <div>
                        ...
                        <div className="sm:col-span-2">
                            ...
                            <div className="mt-2">
                                <select
                                    id="brandNo"
                                    name="brandNo"
                                    value={pdInfo.brandNo='2'}
                                    onChange={handleChangePdInfo}
                                    className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-gray-900 sm:max-w-xs sm:text-sm sm:leading-6"
                                >
                                    <option>나이키</option>
                                </select>
                            </div>
            ...
            <input id='categoryNo' name='categoryNo' type='hidden' value={pdInfo.categoryNo = '2'} onChange={handleChangePdInfo}/>
            <input id='itemNo' name='itemNo' type='hidden' value={pdInfo.itemNo = '2'} onChange={handleChangePdInfo}/>
            <input id='startDate' name='startDate' type='hidden' value={pdInfo.startDate='2024-12-25T10:00:00'} onChange={handleChangePdInfo}/>
            <input id='endDate' name='endDate' type='hidden' value={pdInfo.endDate = '2024-12-25T10:00:00'} onChange={handleChangePdInfo}/>
            <input id='likeCnt' name='likeCnt' type='hidden' value={pdInfo.likeCnt = '0'} onChange={handleChangePdInfo}/>
            ...
            {result ? <ResultModal 
                title={'상품 등록 완료'}
                content={result.pdName + ' 상품이 등록 되었습니다.'}
