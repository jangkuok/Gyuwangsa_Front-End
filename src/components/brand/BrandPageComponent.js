...
function BrandPageComponent({ brandNo }) {
    ...
    }, [categoryNumber, itemNumber, page, size, userId, brandNo])
    ...
    const handleLikeButton = (pdNo) => {
        ...
        brandListPdInfo.dtoList.filter(itemList)
    }
                            ...
                            <div className="bg-white flex mb-6 last:mb-0 rounded-2xl flex-col ">
                                <div className="flex-1 p-6 undefined ">
                                    <div className="flex flex-col xl:flex-row items-center justify-between ">
                                        ...
                                        {brandAdmin === brandInfo.brandNo ?
                                            <div className="text-center md:text-right space-y-2">
                                                <div className='grid grid-cols-3 xl:grid-cols-1'>
                                                    <Link to={`/user/modifyPage/${loginState.userId}`} >
                                                        <button className="py-2 px-4 border bg-gray-900 text-white min-w-32">프로필 관리</button>
                                                    </Link>
                                                    <button onClick={() => handleModifyButton()} className="py-2 px-4 border bg-gray-900 text-white min-w-32">브랜드 수정</button>
